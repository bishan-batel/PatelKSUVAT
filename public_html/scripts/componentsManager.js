 ...
 * The initial reason why I made this was because I planned for this website to be spread apart multiple pages
 * and because I couldn't use a modern javascript framework like React, Angular, Vue, etc, so I thought
 * it would be fun to make my own.
 *
 * What this script does is allows to creation of custom components & javascript binded to said components,
 * along with listeners for when these components are created or remove;
 *
 * To define a component: you need a 'component_name.json', that takes the structure of
 * component_name.json
 * {
 ...
 * }
 *
 * This file will determine the shape of how the component is loaded when another html file references it,
 * and the 'loadComponents()' function is called, for ex.
 *
 * <component path="components/myComponent"></component>
 * <script> loadComponents() </script>
 *
 * Would load all th CSS files, then the HTML files, and then run the javascript.
 */
"use strict";
